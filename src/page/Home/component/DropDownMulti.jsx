    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-50 mt-1 w-full left-0 top-full bg-white border border-gray-300 rounded-md overflow-hidden shadow-lg">
            ...
            {filtered.map(opt => {
              ...
              return (
                <li
                  ...
                  onClick={(e) => { e.stopPropagation(); toggle(opt); }}
                >
                  <span className={`w-4 h-4 border rounded-sm flex items-center justify-center ${isSel ? "bg-blue-600 border-blue-600" : "border-gray-300"}`}>
          ...
          <div className="p-2 border-t bg-gray-50 text-sm text-gray-600 flex justify-between">
