    ...
    return (
        <div className="flex gap-2 h-40 w-full bg-white">
            <div className="flex flex-col gap-2 px-5 py-3 rounded-[8px] border border-neutral-200 w-full h-full relative">
                ...
                <GripVertical className="absolute -left-6 top-1/2 transform -translate-y-1/2" stroke="#737373" />
                <LucideTrash2 className="absolute -right-59 top-1/2 transform -translate-y-1/2" stroke="#737373" strokeWidth={1} />
